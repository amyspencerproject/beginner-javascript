...
// const string2 = "She's so \"cool\" ";
// // const string3 = 'Shes so cool';
// const string3 = 'She\'s so cool';
// const string4 =`She's so "cool"`;
...
// const hello = `Hello my name is ${first}. I am ${100 + 32} years old.`
...
// console.log(a+"1"); // give 11 because of the + plus sign is loaded bc of concatenation

// const round = Math.round(20.5); //rounds number
// const floor = Math.floor(20.999999); //gives lower integer of float
// const ceiling = Math.ceil(20.99999); //gives upper integer of float
// const random = Math.random(); //gives a random float between 0 and 1
